	...
	function formSubmit() {
		...
		function formSent(form, responseResult = ``) {
			...
			if (form.dataset.flsForm === 'dev' && form.closest('[data-fls-popup]')) {
				...
				// Если это CTA форма на странице (cta-form, signup-form или consultation), показываем сообщение об успехе
				...
				const consultationSuccessMessage = form.querySelector('.consultation__success');
				const successMessage = ctaSuccessMessage || signupSuccessMessage || consultationSuccessMessage;
